...
- **To plot a graph between  different vibration ,you can use MATLAB Visualization. **
- **For this go to App ,Click on MATLAB Visualization.**
- **Inside it select, Create 2-D line plots with y-axes on both left and right side **
